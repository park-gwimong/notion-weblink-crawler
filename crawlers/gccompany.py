...
class GCCompanyCrawler(BaseCrawler):
    """여기어때 기술 블로그 크롤러 (RSS 피드)"""

    name = "여기어때"
    source_id = "gccompany"
    base_url = "https://medium.com/gccompany"
...
# 편의를 위한 함수형 인터페이스
def fetch_gccompany_posts():
    """여기어때 기술 블로그에서 최신 글 가져오기"""
    crawler = GCCompanyCrawler()
